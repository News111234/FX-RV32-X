...
HD_PWD='D:/Path/RISC-V-TEST/Project/FX-RV32/vivado/RISCV_TEST/RISCV_TEST.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log soc_top_fpga.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source soc_top_fpga.tcl
