...
always @(*) begin
    case (opcode)
        ...
        begin
            // 立即数位排列: {imm[12], imm[11], imm[10:5], imm[4:1], 1'b0}
            // 对应指令位: {instr[31], instr[7], instr[30:25], instr[11:8], 0}
            // RISC-V spec: offset[12:1] = {inst[31], inst[7], inst[30:25], inst[11:8]}
            imm_o = {{20{instr_i[31]}}, instr_i[7],
