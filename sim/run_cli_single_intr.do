# run_cli_single_intr.do — CLI: single_intr_test (BANKS=4)
# 用法: cd sim && vsim -c -do run_cli_single_intr.do
...
puts "mem\[64\] = $r (expected 32'hDEAD0001)"
if {[string equal -nocase $r 32'hDEAD0001]} { puts "=> PASS" } else { puts "=> FAIL ***" }
quit -f
