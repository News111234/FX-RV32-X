# run_cli_overflow_min.do - CLI: overflow_minimal (BANKS=1)
...
vsim -onfinish stop -c -gUSE_INST_ROM=1 -gSHADOW_BANKS=1 work.tb_nested_check
run 10us
set r [exam u_soc_top/u_data_ram/mem\[64\]]
puts "mem\[64\] = $r (expected 32'h00000042)"
if {[string equal -nocase $r 32'h00000042]} { puts "=> PASS" } else { puts "=> FAIL ***" }
quit -f
