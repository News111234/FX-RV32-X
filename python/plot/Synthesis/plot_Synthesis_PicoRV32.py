...
area = [
    ...
    20808, 33086,           # PicoRV32 base, full
    83924                   # OpenE902
]
...
fig, ax1 = plt.subplots(figsize=(13, 6))   # 宽度再增加一点以适应更多标签
...
ax1.set_xticks(x)
ax1.set_xticklabels(cpu_modes, rotation=30, ha='right', fontsize=8)
